...
// ---------- isolated installs (`tdsp install --profile <name>`) ----------
// A profile is a complete node identity that shares only the source checkout.
// Its sqlite, mirrors, worktrees, namespace, SSH control sockets and launcher all
// live below ~/.task-dispatcher/profiles/<name>. This is useful for a side-by-side
// canary and, importantly, cannot repoint or open the canonical live instance.

export function validProfileName(profile: string): boolean {
