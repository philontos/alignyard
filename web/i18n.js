...
(function () {
  const DICT = {
    zh: {
      ...
      "repo.infoOpen": "查看仓库信息",
      "repo.infoTitle": "仓库信息",
      "repo.infoMachine": "所属机器",
      "repo.infoUrl": "Git 地址",
      "repo.infoBranch": "默认分支",
      "repo.infoStatus": "状态",
      "repo.infoCreated": "添加时间",
      "repo.infoStatusReady": "已就绪",
      "repo.infoStatusChecking": "校验中",
      "repo.infoStatusError": "连接失败",
      "repo.infoStatusUnknown": "未知",
      "repo.infoUnavailable": "仓库信息已不可用，请刷新后重试。",
      "repo.expandTasks": "展开仓库任务",
      "repo.collapseTasks": "收起仓库任务",
      ...
      "task.referencesLabel": "引用仓库（可选）",
      "task.addReference": "＋ 添加引用",
      "task.referencesHint": "引用会固定到所选分支的当前提交，仅用于参考。",
      "task.noReferenceRepos": "当前节点没有其他可引用的仓库",
      "task.referencesUnsupported": "目标节点需要升级后才能使用仓库引用",
      "task.referenceRepo": "引用仓库",
      "task.referenceBranch": "引用分支",
      "task.referenceAlias": "别名",
      "task.referenceRemove": "移除引用",
      "task.referenceLoading": "加载…",
      "runtimeRef.short": "Ref",
      "runtimeRef.open": "给当前任务添加 Ref",
      "runtimeRef.title": "运行时添加 Ref",
      "runtimeRef.taskMeta": "任务 #{id} · {title} · {agent} · 已有 {count} 个 Ref",
      "runtimeRef.repo": "引用仓库",
      "runtimeRef.branch": "固定到分支当前提交",
      "runtimeRef.alias": "别名",
      "runtimeRef.aliasPh": "例如 frontend",
      "runtimeRef.claudeHint": "Claude 会在当前会话原位执行 /add-dir，不会重启或丢失对话上下文。请在输入框没有未发送草稿时添加。",
      "runtimeRef.resumeHint": "{agent} 会保持当前 tmux pane，并通过原生 resume 接回同一对话；若当前一轮仍在执行，会被中断，请在空闲时添加。",
      "runtimeRef.noRepos": "当前节点没有其他可引用的仓库",
      "runtimeRef.limit": "当前任务已经有 8 个 Ref",
      "runtimeRef.loadingBranches": "正在加载分支…",
      "runtimeRef.submit": "添加并加载",
      "runtimeRef.adding": "正在 fetch 并创建引用 worktree…",
      "runtimeRef.attached": "已添加 ref:{alias}",
      "runtimeRef.attachedInPlace": "已添加 ref:{alias}，Claude 会话保持原位",
      "runtimeRef.attachedResumed": "已添加 ref:{alias}，{agent} 已恢复原对话",
      "runtimeRef.attachedDeferred": "已添加 ref:{alias}，将在下次恢复会话时加载",
      "runtimeRef.already": "ref:{alias} 已经在当前任务中",
      "runtimeRef.nodeUpdate": "该节点版本不支持运行时 Ref，请先更新节点",
      "task.titlePh": "任务标题",
    ...
    en: {
      ...
      "repo.infoOpen": "View repository information",
      "repo.infoTitle": "Repository information",
      "repo.infoMachine": "Machine",
      "repo.infoUrl": "Git URL",
      "repo.infoBranch": "Default branch",
      "repo.infoStatus": "Status",
      "repo.infoCreated": "Added",
      ...
      "repo.infoUnavailable": "Repository information is no longer available. Refresh and try again.",
      "repo.expandTasks": "Expand repository tasks",
      "repo.collapseTasks": "Collapse repository tasks",
      ...
      "task.referencesLabel": "Repository references (optional)",
      "task.addReference": "＋ Add reference",
      "task.referencesHint": "References are pinned to the selected branch's current commit and used for context.",
      "task.noReferenceRepos": "No other repositories are available on this node",
      "task.referencesUnsupported": "Update the target node to use repository references",
      "task.referenceRepo": "Reference repository",
      "task.referenceBranch": "Reference branch",
      "task.referenceAlias": "Alias",
      "task.referenceRemove": "Remove reference",
      "task.referenceLoading": "Loading…",
      "runtimeRef.short": "Ref",
      "runtimeRef.open": "Add a Ref to this task",
      "runtimeRef.title": "Add Ref at runtime",
      "runtimeRef.taskMeta": "Task #{id} · {title} · {agent} · {count} Ref(s) attached",
      "runtimeRef.repo": "Reference repository",
      "runtimeRef.branch": "Pin the branch's current commit",
      "runtimeRef.alias": "Alias",
      "runtimeRef.aliasPh": "e.g. frontend",
      "runtimeRef.claudeHint": "Claude runs /add-dir inside the current session, without restarting or losing conversation context. Add it when the input has no unsent draft.",
      "runtimeRef.resumeHint": "{agent} keeps the current tmux pane and uses native resume to restore the same conversation. An active turn will be interrupted, so add it while idle.",
      "runtimeRef.noRepos": "No other repositories are available on this node",
      "runtimeRef.limit": "This task already has 8 Refs",
      "runtimeRef.loadingBranches": "Loading branches…",
      "runtimeRef.submit": "Add & load",
      "runtimeRef.adding": "Fetching and creating the reference worktree…",
      "runtimeRef.attached": "Added ref:{alias}",
      "runtimeRef.attachedInPlace": "Added ref:{alias}; the Claude session stayed in place",
      "runtimeRef.attachedResumed": "Added ref:{alias}; {agent} resumed the same conversation",
      "runtimeRef.attachedDeferred": "Added ref:{alias}; it will load on the next session resume",
      "runtimeRef.already": "ref:{alias} is already attached to this task",
      "runtimeRef.nodeUpdate": "This node does not support runtime Refs yet; update it first",
      ...
      "read.unavailable": "Read is temporarily unavailable. Retrying…",
      "read.you": "You",
